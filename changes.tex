...
\begin{algorithm}[!ht]
	...
	\caption{Code inserted into the three variants proposed by \textit{Schwarzrock et al.} in \cite{MAS07} to  better deal with the dynamism defined in Section \ref{sec:dynamic_scenario} }
	\label{algo:change}
